...
Description: interface of class Set
*/
...
class Set : public SetInterface<ItemType>
{
  public:
    ...
    @post If successful, newEntry is stored in the set 
    and the count of items in the set has increased by 1.
    ...
    and the count of tiems in the set has decreased by 1.
